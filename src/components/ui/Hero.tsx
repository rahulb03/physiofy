...
//                   News AI Recovery Assistant Launch
//                 </span>
...
//           <br />
//           <FadeSpan>every</FadeSpan> <FadeSpan>body</FadeSpan>
//         </h1>
//         <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
//           <FadeSpan>  Revolutionizing physiotherapy with AI-powered assessments , personalized recovery plans .</FadeSpan>{" "}
//           {/* <FadeSpan></FadeSpan>{" "} */}
//           {/* <FadeSpan>sustainable and efficient farming.</FadeSpan> */}
          
//           {/* Revolutionizing physiotherapy with AI-powered assessments, personalized recovery plans, and intelligent guidance for faster, smarter healing */}
//         </p>
//         <FadeDiv>
//           <a
  ...
  return (
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
        <FadeDiv className="mx-auto">
          ...
          > */}
            <div className="inline-flex max-w-full items-center gap-3 rounded-full bg-white/5 px-2.5 py-0.5 pr-3 pl-0.5 font-medium text-gray-900 ring-1 shadow-lg shadow-blue-400/20 ring-black/10 filter backdrop-blur-[1px] transition-colors hover:bg-blue-500/[2.5%] focus:outline-hidden sm:text-sm">
              ...
              <span className="px-4 py-1 flex items-center gap-1 truncate">
                <span className="w-full truncate">
                  News AI Recovery Assistant Launch
                </span>
        ...
        {/* <FadeDiv>
          <a
            className="mt-6 inline-flex cursor-pointer flex-row items-center justify-center gap-1 rounded-md border-b-[1.5px] border-blue-700 bg-gradient-to-b from-[#0087d3] to-[#0069a7] px-5 py-3 leading-4 font-medium tracking-wide whitespace-nowrap text-white shadow-[0_0_0_2px_rgba(0,0,0,0.04),0_0_14px_0_rgba(255,255,255,0.19)] transition-all duration-200 ease-in-out hover:shadow-blue-300"
            href="#"
          >
            Automate now
          </a>
