...
const summary = [
  {
    ...
    value: "213 patients",
    expected: "190 patients",
    sessions: "1,403 sessions",
    recovery: "+11.2%",
    satisfaction: "+7.8%",
    painReduction: "+4.9%",
    bgColor: "bg-theme",
  ...
  {
    name: "AI-Guided Exercises",
    value: "259 patients",
    expected: "236 patients",
    sessions: "1,103 sessions",
    recovery: "+3.1%",
    satisfaction: "+5.6%",
    painReduction: "+2.9%",
    bgColor: "bg-emerald-500",
  ...
  },
  {
    ...
    value: "94 patients",
    expected: "146 patients",
    sessions: "203 sessions",
    recovery: "-5.1%",
    satisfaction: "-6.3%",
    painReduction: "-9.9%",
    bgColor: "bg-yellow-400",
...
export default function PatientPerformance() {
  return (
    <div className="h-150 shrink-0 overflow-hidden [mask-image:radial-gradient(white_30%,transparent_90%)] perspective-[4000px] perspective-origin-center">
      <div className="-translate-y-10 -translate-z-10 rotate-x-10 rotate-y-20 -rotate-z-10 transform-3d">
        <h3 className="text-sm text-gray-500">Patient Recovery Performance</h3>
        <p className="mt-1 text-3xl font-semibold text-gray-900">566 patients treated</p>
        <p className="mt-1 text-sm font-medium">
          <span className="text-theme">+43 patients (4.1%)</span>{" "}
        ...
        <TableRoot className="mt-6 min-w-200">
          <Table>
            <TableHead>
              <TableRow>
                <TableHeaderCell>Treatment Type</TableHeaderCell>
                <TableHeaderCell className="text-right">Patients</TableHeaderCell>
                ...
                <TableHeaderCell className="text-right">Recovery Rate</TableHeaderCell>
                <TableHeaderCell className="text-right">Satisfaction</TableHeaderCell>
                <TableHeaderCell className="text-right">Pain Reduction</TableHeaderCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {summary.map((item) => (
                <TableRow key={item.name}>
                  ...
                  <TableCell className="text-right">
                    <span className={item.changeType === "positive" ? "text-theme" : "text-red-700"}>
                      {item.recovery}
                    </span>
                  </TableCell>
                  <TableCell className="text-right">
